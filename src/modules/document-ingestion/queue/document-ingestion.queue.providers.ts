...
import { DOCUMENT_QUEUE } from '@/modules/upload-documents/constants/document-queue.constant';
...
export const documentQueueProviders: Provider[] = [
  ...
  },
  {
    ...
    useFactory: (connection: IORedis, processor: DocumentIngestionProcessor) => {
      return new Worker(
        DOCUMENT_QUEUE,
