...
import { DocumentChunkEntity } from 'src/modules/upload-documents/entities/document-chunk.entity';
import { DocumentAiKnowledge } from 'src/modules/upload-documents/entities/document-ai-knowledge.entity';
