...
export class V111UpdatePartyAdmissionModule1773677171088 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "party_admissions" DROP CONSTRAINT "REL_3e51862ee13bdce5eb974b7865"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."party_admissions_status_enum" AS ENUM('SUBMITTED', 'REVIEWING', 'CHECKED', 'VERIFIED', 'REJECTED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "party_admissions" ADD CONSTRAINT "REL_3e51862ee13bdce5eb974b7865" UNIQUE ("member_id")`);
