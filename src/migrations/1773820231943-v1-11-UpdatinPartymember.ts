...
export class V111UpdatinPartymember1773820231943 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "party_members" ADD "ethnicity" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ADD "religion" character varying(50)`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ADD "target_group" character varying(100)`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ADD "academic_level" character varying(100)`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ADD "political_theory_level" character varying(100)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."party_admissions_status_enum_old" AS ENUM('SUBMITTED', 'REVIEWING', 'CHECKED', 'VERIFIED', 'REJECTED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_admissions" ALTER COLUMN "status" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "party_members" DROP COLUMN "political_theory_level"`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" DROP COLUMN "academic_level"`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" DROP COLUMN "target_group"`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" DROP COLUMN "religion"`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" DROP COLUMN "ethnicity"`,
    );
    await queryRunner.query(
