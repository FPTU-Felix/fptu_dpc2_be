...
export class V112UpdateMeetingDocument1774494534465 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "meeting_documents" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "meeting_id" uuid NOT NULL, "original_name" character varying NOT NULL, "file_url" character varying NOT NULL, "file_size" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_87263cf3c23670926615b91ceb6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`ALTER TABLE "meetings" DROP COLUMN "minutes_url"`);
    await queryRunner.query(
      `ALTER TABLE "party_admissions" DROP CONSTRAINT "UQ_3e51862ee13bdce5eb974b78650"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."party_admissions_status_enum" AS ENUM('SUBMITTED', 'CHECKED', 'VERIFIED', 'REJECTED')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ai_knowledge_base" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "ai_knowledge_base" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "handbook_links" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "handbook_links" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "handbooks" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "handbooks" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "party_admissions" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_admissions" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "system_audit_logs" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "system_audit_logs" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_members" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "party_member_positions" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_member_positions" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_positions" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_positions" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "disciplines" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "disciplines" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "commendations" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "commendations" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "annual_assessments" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "annual_assessments" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_fees" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_fees" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "admission_progress" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "admission_progress" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_cells" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "party_cells" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "meetings" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "meetings" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "meeting_opinions" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "meeting_opinions" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "meeting_attendees" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "meeting_attendees" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "meeting_sessions" ALTER COLUMN "id" SET DEFAULT extensions.gen_random_uuid()`,
    );
    await queryRunner.query(
      `ALTER TABLE "meeting_sessions" ALTER COLUMN "id" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "party_admissions" ADD CONSTRAINT "UQ_3e51862ee13bdce5eb974b78650" UNIQUE ("member_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "meetings" ADD "minutes_url" character varying`,
    );
